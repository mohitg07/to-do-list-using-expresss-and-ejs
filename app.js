...
// here "admin-mohit" is my username for mongoDB cluster
// and "webdev123" is my password from mongoDB cluster
// and "todolistDB" is the name of my database where I am storing data for this to-do-list app
mongoose.connect('mongodb+srv://admin-mohit:webdev123@cluster0.otbtt.mongodb.net/todolistDB', {useNewUrlParser: true, useUnifiedTopology: true});
